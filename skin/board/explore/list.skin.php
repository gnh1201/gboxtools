	...
	<div class="box-body">
	  <table class="table table-bordered">
		<tr>
		  ...
		  <th style="width: 45px;"><input type="checkbox" id="chk_all" title="모두선택" /></th>
		  <th>파일명</th>
		  <th style="width: 120px;">수집자</th>
		  <th style="width: 120px;">수집위치</th>
		  <th style="width: 200px;">수집일자</th>
		</tr>
...
<?php } ?>
	...
	<div class="box-footer clearfix">
	  ...
	  <a href="<?php echo G5_PLUGIN_URL; ?>/boxtools/secure/encrypt_all.php?bo_table=<?php echo $bo_table; ?>" class="btn btn-primary">암호화</a>
