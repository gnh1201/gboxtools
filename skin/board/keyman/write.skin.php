...
if(!in_array($w, $w_flags)) {
	...
	$subject = $name . "님의 새로운 암호키 " . G5_TIME_YMDHIS;
	$content = $subject;
}
?>
...
?>
		<div class="form-group">
		  <label for="wr_<?php echo $i; ?>" class="col-sm-2 control-label">부가정보 #<?php echo $i; ?></label>

		  <div class="col-sm-10">
			<textarea class="form-control" name="wr_<?php echo $i; ?>" id="wr_<?php echo $i; ?>" rows="2" placeholder="부가정보 #<?php echo $i; ?>"><?php echo $write['wr_' . $i]; ?></textarea>
		  </div>
		</div>
<?php
		}
