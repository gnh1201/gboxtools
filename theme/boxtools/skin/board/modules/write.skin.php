  ...
  <div class="box box-info">
	...
	<form class="form-horizontal" name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
	  ...
	  <div class="box-body">
		...
		<div class="form-group">
		  <label for="wr_2" class="col-sm-2 control-label">식별코드</label>

		  <div class="col-sm-10">
			<input class="form-control" type="text" name="wr_2" value="<?php echo $write['wr_2'] ?>" id="wr_2" class="frm_input" size="50" placeholder="식별코드"/>
          </div>
		</div>
		
		<div class="form-group">
		  <label for="wr_3" class="col-sm-2 control-label">암호키 관리번호</label>

		  <div class="col-sm-10">
			<input class="form-control" type="text" name="wr_3" value="<?php echo $write['wr_3'] ?>" id="wr_3" class="frm_input" size="50" placeholder="암호키 관리번호"/>
          </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-10">
			<input type="text" class="form-control" id="wr_link<?php echo $i ?>" value="<?php if($w=="u"){echo$write['wr_link'.$i];} ?>" name="wr_link<?php echo $i ?>" placeholder="링크 #<?php echo $i ?>"/>
		  </div>
		</div>
        <?php } ?>
